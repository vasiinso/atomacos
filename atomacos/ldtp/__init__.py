...
def imagecapture(
    window_name=None, out_file=None, x=0, y=0, width=None, height=None
):
    """
...
def waittillguiexist(window_name, object_name="", guiTimeOut=30, state=""):
    return _remote_waittillguiexist(window_name, object_name, guiTimeOut)


def waittillguinotexist(window_name, object_name="", guiTimeOut=30, state=""):
    return _remote_waittillguinotexist(window_name, object_name, guiTimeOut)
...
def generatemouseevent(
    x, y, event_type="b1c", drag_button_override="drag_default_button"
):
